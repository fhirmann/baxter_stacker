...
def handle_put_down(req):
  ...
  print("[kmr19_manipulation_server]: Got request to put down block add x: %d ; y: %d ; z: %d " %req.end_position.pose.position.x %req.end_position.pose.position.y %req.end_position.pose.position.z)
